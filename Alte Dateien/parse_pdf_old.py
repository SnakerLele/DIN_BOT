...
def load_and_process_pdfs():
    ...
    print("✓ Verwende lokale Unstructured-Installation")
            ...
            try:
                ...
                if not file_documents:
                    ...
                    try:
                        ...
                        # Fallback: LlamaIndex UnstructuredReader
                        if local_reader_works:
                            print(f"→ Fallback: Verwende LlamaIndex UnstructuredReader")
                            try:
